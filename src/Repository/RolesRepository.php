...
class RolesRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, IntRoles::class);
    }

    public function add(IntRoles $entity, bool $flush = false): void
    {
    ...
    public function remove(IntRoles $entity, bool $flush = false): void
    {
